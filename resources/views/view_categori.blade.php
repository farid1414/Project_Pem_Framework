...
<div class="title">
    @if ($kategori->id == 1)
        <h4>Daftar Tiket Webinar</h4>    
    @elseif ($kategori->id == 2)
        <h4>Daftar Tiket Workshop</h4>
    @elseif ($kategori->id == 3)
        <h4>Daftar Tiket Film</h4>
    @elseif ($kategori->id == 4)
        <h4>Daftar Tiket Konser</h4>       
    @endif
</div>
<form class="mt-4 mb-4 form-inline cari-tiket justify-content-center" action="/categori/{{$kategori->id}}">
        ...
        <div class="modal-header">
          ...
          <form action="/beli-tiket" method="POST">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="judul" class="form-control" readonly id="jadwal">
              </div>
              <div class="form-group">
